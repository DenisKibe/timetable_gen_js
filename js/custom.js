...
$(document).ready(function(){
    ...
    count=0
       ...
       for(let i=0;i<JSON.parse(localStorage.finalTimetable).length;i++){
           ...
           $('#content').append('<div class="card my-3"><!--Title--><h3 class="card-header-title mb-3 text-center pt-2"><strong>'+JSON.parse(localStorage.TimetableDatils)['School_Name']+'</strong></h3><h5 class="text-center"><strong class="float-left pl-5 ml-5">'+JSON.parse(localStorage.TimetableDatils)['Stream_Name']+'</strong><strong class="float-right pr-5 mr-5">'+JSON.parse(localStorage.TimetableDatils)['School_Term']+'</strong></h5><div class="card-body table-responsive"><table class="table table-bordered table-sm"><thead><tr><th scope="col">#</th><th scope="col">8:00-8:40</th><th scope="col">8:40-9:20</th><th scope="col">9:20-9:30</th><th scope="col">9:30-10:10</th><th scope="col">10:10-10:50</th><th scope="col">10:50-11:20</th><th scope="col">11:20-12:00</th><th scope="col">12:00-12:40</th><th scope="col">12:40-1:20</th><th scope="col">1:20-2:00</th><th scope="col">2:00-2:40</th><th scope="col">2:40-3:20</th><th scope="col">3:20-4:00</th></tr></thead><tbody id="r'+count+'x'+i+'"></tbody></table></div>');
